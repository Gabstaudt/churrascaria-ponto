...
As Sprints 1 a 8 foram implementadas e validadas com PostgreSQL local. O primeiro
...
O próximo trabalho planejado é a Sprint 9: situação diária e dashboard operacional.
