...
import { confirmEmployeeCertificateAction, prepareEmployeeCertificateAction } from "@/actions/portal";
...
export function MedicalCertificateForm({ employees, employeeId, absenceId, date, portal = false }: { employees: Employee[]; employeeId?: string; absenceId?: string; date?: string; portal?: boolean }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const prepared = portal ? await prepareEmployeeCertificateAction(input) : await prepareMedicalCertificateUploadAction(input);
