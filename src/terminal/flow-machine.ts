...
export type TerminalFlowState = { status: TerminalFlowStatus; locationValidationId?: string; biometricValidationId?: string; attemptId?: string; contingencyTicket?: string; employee?: IdentifiedEmployee; result?: { eventLabel: string; recordedAt: string; nsr: string }; error?: string; failureCode?: string };
