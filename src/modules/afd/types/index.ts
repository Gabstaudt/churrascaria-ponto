...
export type AfdSource = { registrar: { id: string; name: string; identifier: string; status: string; mode: string }; establishment: { id: string; name: string; cnpj: string; timezone: string }; employer: { name: string; idType: string; id: string; cno?: string | null; caepf?: string | null }; developer: { idType: string; id: string }; entries: AfdClockRecord[] };
